...
if TYPE_CHECKING:
    from nanobot.config.schema import AgentDefaults, Config, ExecToolConfig, WebSearchConfig
...
class SpawnedAgentRuntime:
    ...
    def __init__(
        ...
        from nanobot.config.schema import AgentDefaults, ExecToolConfig, WebSearchConfig
        ...
        self.max_tool_result_chars = max_tool_result_chars or AgentDefaults().max_tool_result_chars
