...
class SpawnedAgentRuntime(_BaseSpawnedAgentRuntime):
    ...
    def _build_agent_prompt(self, role: str | None = None) -> str:
        """Honor disabled skill filters while preserving runtime behavior."""
        from nanobot.agent.context import ContextBuilder
...
class AgentLoop:
    ...
    def __init__(
        ...
        self.subagents = self.spawned_agents
    ...
    def _register_default_tools(self) -> None:
        ...
        self.tools.register(SpawnTool(manager=self.spawned_agents))
    ...
    async def _process_message(
        ...
        if msg.channel == "system":
            ...
            current_role = "assistant" if SpawnedAgentRuntime.is_internal_message(msg) else "user"
